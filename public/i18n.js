...
export const TRANSLATIONS = {
  zh: {
    ...
    dock_llm_name: 'LLM 大模型',
    dock_offline: '离线/未连接',
    dock_wait_key: '待配置密钥',
    btn_settings: '模型服务设置',
    lang_btn_text: 'EN',

    // VS Screen - 3-Way Architectural Comparison
    left_tag_llm: 'CLOUD LLM · Direct Prompt (End-to-End)',
    left_blurb_llm: '纯 Prompt 大模型直接推演落子。受限于自回归 Token 生成与网络往返，决策耗时较高（~800-1500ms），易受下落重力压迫，直观展现纯大模型在高速物理反射场景的局限性。',
    mid_tag_jev: 'HYBRID · Cloud System 1 + LLM System 2',
    mid_blurb_jev: 'TypeSafe Jev 云端离散分类 System 1 协同 LLM 战术规划。深入评估盘面地貌，深算 Back-to-Back 连锁与 T-Spin Double，决策平稳精准 (~180-250ms)。',
    right_tag_laya: 'ACCELERATED · Local GPU ModernBERT + LLM',
    ...
    mode_tri: '🔥 三雄大决战: LLM vs LLM+Jev vs LLM+Laya (三方同台)',
    mode_jev_laya: '⚡ 双雄巅峰战: LLM+Jev vs LLM+Laya',
    mode_llm_jev: '🐢 纯大模型 vs 混合云端: LLM vs LLM+Jev',
    mode_llm_laya: '🚀 纯大模型 vs 本地GPU: LLM vs LLM+Laya',
    mode_human_tri: '🎮 人类挑战三雄: 人类玩家 vs LLM vs LAYA',
  ...
  en: {
    ...
    // VS Screen - 3-Way Architectural Comparison
    left_tag_llm: 'CLOUD LLM · Direct Prompt (End-to-End)',
    left_blurb_llm: 'Direct prompt inference on foundation LLM. Bound by autoregressive token generation latency (~800-1500ms), showcasing the fundamental limits of pure System 2 under high-speed gravity.',
    mid_tag_jev: 'HYBRID · Cloud System 1 + LLM System 2',
    mid_blurb_jev: 'TypeSafe Jev Cloud System 1 discrete classification paired with LLM tactical guidance. Calculated board foresight, B2B chains and T-Spins with steady ~190ms pacing.',
    right_tag_laya: 'ACCELERATED · Local GPU ModernBERT + LLM',
    right_blurb_laya: 'NVIDIA TITAN RTX on-premise GPU accelerating ModernBERT embeddings. 35-45ms latency with rapid drops, high-frequency line clears and rock-solid defense.',
    left_tag_cloud: 'CLOUD AI · TypeSafe Jev',
    ...
    mode_tri: '🔥 Tri-Battle: LLM vs LLM+Jev vs LLM+Laya (3-Way Showdown)',
    mode_jev_laya: '⚡ Duel: LLM+Jev vs LLM+Laya',
    mode_llm_jev: '🐢 Duel: LLM vs LLM+Jev',
    mode_llm_laya: '🚀 Duel: LLM vs LLM+Laya',
    mode_human_tri: '🎮 Human Tri-Challenge: Human vs LLM vs LAYA',
